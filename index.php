...
<body>
  <div class="wrapper">
    <section class="form signup">
      ...
      <form action="php_signup.php" method="POST" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="field button">
          <input type="submit" name="submit" value="REGISTER TO START CHATTING">
        </div>
      </form>
      <div class="link"> <i style="color:blue;"> Already signed up?</i> <a href="login.php">Login now</a></div>
    </section>
  </div>
...
continueBtn.onclick = ()=>{
    ...
    xhr.open("POST", "php_signup.php", true);
    xhr.onload = ()=>{
